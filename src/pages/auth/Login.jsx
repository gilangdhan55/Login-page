...
const PageLoginRight = () => {   
  return (
    <div className="w-full lg:w-2/4 h-full p-8 flex flex-col justify-center items-center bg-gray-50 px-10 shadow border-l-2 border-slate-500">  
       <div className='border border-gray-300 shadow rounded-lg p-10'>
          <div className="info mb-4 flex items-center flex-col w-full">
              <div className='flex items-center mb-4'>
                  <img src="/images/logopk.png" className='mix-blend-multiply rounded-full w-10' alt="icon" />
